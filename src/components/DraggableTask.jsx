  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragging ? 'scale-105 rotate-1 shadow-2xl' : 'hover:scale-105 hover:shadow-2xl'}
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <div className="flex space-x-2">
          <button
            onClick={handleEdit}
            className="edit-btn text-amber-600 hover:text-amber-800 transition-colors p-2 text-lg hover:scale-110 bg-amber-50 rounded-full"
            title="Edit task"
          >
            ✏️
          </button>
          <button
            ...
            className="delete-btn text-red-600 hover:text-red-800 transition-colors p-2 text-lg hover:scale-110 bg-red-50 rounded-full"
            title="Delete task"
          >
            🗑️
          </button>
